...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_bootstrap_content_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='bootstrap-content'
        )
        self.assertTrue(view.__name__ == 'bootstrap-content')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in bootstrap-content'
        # )

    def test_bootstrap_content_not_matching_interface(self):
