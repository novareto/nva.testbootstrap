...
class ViewsIntegrationTest(unittest.TestCase):
    ...
    def test_bootstrap_form_is_registered(self):
        view = getMultiAdapter(
            (self.portal['other-folder'], self.portal.REQUEST),
            name='bootstrap-form'
        )
        self.assertTrue(view.__name__ == 'bootstrap-form')
        # self.assertTrue(
        #     'Sample View' in view(),
        #     'Sample View is not found in bootstrap-form'
        # )

    def test_bootstrap_form_not_matching_interface(self):
